...
def is_mel(name, email):
    ...
    >>> is_mel('Jane Doe', 'jane@gmail.com')
    False
    
    >>> is_mel('Mel Melitpolski', 'jane@gmail.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'appetizer'},{'type': 'dessert'},{'type': 'appetizer'},{'type': 'drink'}])
    ('appetizer', 'drink')
